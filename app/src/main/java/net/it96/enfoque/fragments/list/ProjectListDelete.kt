...
class ProjectListDelete (var adapter : ProjectListAdapter, var context : Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        val project = adapter.getObject(viewHolder.adapterPosition)
        adapter.deleteProject(project, viewHolder)
    }
